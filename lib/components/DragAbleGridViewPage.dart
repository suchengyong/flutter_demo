...
class DragAbleGridViewPage extends StatefulWidget {
  ...
  State<StatefulWidget> createState() {
    return new DragAbleGridViewPageState();
  }
}

class DragAbleGridViewPageState extends State<DragAbleGridViewPage> {
  ...
  Widget build(BuildContext context) {
    return new Scaffold(
      ...
      body: new DragAbleGridView(
        ...
        /******************************new parameter*********************************/
        deleteIcon: new Image.asset("assets/images/close.png",
