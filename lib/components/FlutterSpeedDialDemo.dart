...
class _demoState extends State<FlutterSpeedDialDemo> {
  ...
  void onButtonClick(context, index) {
    Scaffold.of(context)
        .showSnackBar(new SnackBar(content: Text("点击了第$index 个按钮")));
  }
