...
///真正意义上的Toast,可以在任何你需要的时候调用,不会有任何限制(自动管理context).
class BotToastDemoPage extends StatefulWidget {
  BotToastDemoPage({Key key}) : super(key: key);

  @override
  _BotToastDemoState createState() => _BotToastDemoState();
}

class _BotToastDemoState extends State<BotToastDemoPage> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("真正意义上的Toast"),
      ),
      body: Center(
        child: Column(
          children: <Widget>[
              ...
              return FlatButton(
                ...
                onPressed: () {
                  ...
                  BotToast.showAttachedWidget(
                    ...
                    preferDirection:
                        PreferDirection.rightCenter, //吸附于当前点击的按钮 右侧中间
