...
class LoginButtonAnimationPage extends StatefulWidget {
  final String loginTip = "登陆";
  final double width = 200.0, height = 40.0;

  @override
  State<StatefulWidget> createState() {
    return new LoginButtonAnimationState();
  }
}

class LoginButtonAnimationState extends State<LoginButtonAnimationPage> {
  //使用系统的请求
  var httpClient = new HttpClient();
  var url = "https://news-at.zhihu.com/api/4/stories/latest";
  var _result = "";
            ...
            onTap: () async {
              try {
                ...
                if (response.statusCode == HttpStatus.ok) {
                  ...
                  print(_result);
                  //拿到数据后，隐藏动画还原按钮
                  //loginErrorMessageController.hideLoading();
                  //拿到数据后，对数据进行梳理
...
class AnimatedLoginButtonState extends State<AnimatedLoginButton>
    with TickerProviderStateMixin<AnimatedLoginButton> {
