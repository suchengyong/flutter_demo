...
class DrawableStartTextPage extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return new Scaffold(
      appBar: new AppBar(
        title: new Text("文字的开头添加图标或者图片"),
      ),
      body: new Center(
        child: new Container(
          child: new DrawableStartText(
            assetImage: "assets/images/tianmao.jpg",
            text:
                " 莫顿 全自动感应壁自动感应壁挂式酒精喷雾式手自动感应壁挂式酒精喷雾式手消毒器自动感应壁挂式酒精喷雾式手自动感应壁挂式酒精喷雾式手消毒器自动感应壁挂式酒精喷雾式手自动感应壁挂式酒精喷雾式手消毒器自动感应壁挂式酒精喷雾式手自动感应壁挂式酒精喷雾式手消毒器挂式酒精喷雾式手自动感应壁挂式酒精喷雾式手消毒器自动感应壁挂式酒精喷雾式手消毒器自动感应壁挂式酒精喷雾式手消毒器消毒器 手消毒机杀菌净手器",
